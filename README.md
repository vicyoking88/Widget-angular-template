...
- En la raiz del proyecto encontraras una carpeta con el nombre `css` que contiene una hoja de stylos (`style.css`) y un logo (`logo.png`), allí podras personalizar visualmente la documentación al igual que cambiar el logo de acuerdo a sus requerimientos.
